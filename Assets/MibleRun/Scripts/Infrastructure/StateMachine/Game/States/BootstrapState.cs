...
namespace Scripts.Infrastructure.StateMachine.Game.States
{
    public class BootstrapState : IState, IGameState
    {
        ...
        public BootstrapState(IStateMachine<IGameState> stateMachine, ISceneLoader sceneLoader, IStaticDataService staticDataService, ILoadingCurtain loadingCurtain)
        {
